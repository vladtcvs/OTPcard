...
public class OTPCard_AdminPIN_Test {
    ...
    public void Success() {
        // Send APDU
        byte[] apdu_good1 = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '8', 8, '8', '7', '6', '5', '4', '3', '2', '1'};
        byte[] apdu_good2 = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '8', '7', '6', '5', '4', '3', '2', '1', 8, '8', '7', '6', '5', '4', '3', '2', '1'};

        // Send APDU - change admin pin
        byte[] resp = sim.transmitCommand(apdu_good1);
        assertArrayEquals(new byte[]{(byte)0x90, (byte)0x00}, resp);

        // new attempt with new admin pin
    ...
    public void Wrong_PIN() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '7', 8, '8', '7', '6', '5', '4', '3', '2', '1'};
    ...
    public void Wrong_length_1() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '8', 9, '8', '7', '6', '5', '4', '3', '2', '1'};
        byte[] resp = sim.transmitCommand(apdu);
    ...
    public void Wrong_length_2() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '8', 7, '8', '7', '6', '5', '4', '3', '2', '1'};
        byte[] resp = sim.transmitCommand(apdu);
        assertArrayEquals(new byte[]{(byte)0x67, (byte)0x00}, resp);
    }

    @Test
    public void Wrong_admin_pin_lock() {
        // Send APDU
        byte[] apdu_bad = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '7', 8, '8', '7', '6', '5', '4', '3', '2', '1'};
        byte[] apdu_good = {(byte)0x00, 0x07, 0x00, 0x00, 18, 8, '1', '2', '3', '4', '5', '6', '7', '8', 8, '8', '7', '6', '5', '4', '3', '2', '1'};
        ...
        // Send APDU - 4-th attempt - should fail even with good admin pin
