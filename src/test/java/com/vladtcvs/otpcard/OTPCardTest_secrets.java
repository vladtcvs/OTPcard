...
public class OTPCardTest_secrets {
    ...
    @Test
    public void store() {
        byte[] apdu = {(byte)0x00, 0x03, 0x00, 0x00, 21, 6, '1', '2', '3', '4', '5', '6', 0, 6, 'S', 'E', 'C', 'R', 'E', 'T', 4, 'N', 'A', 'M', 'E', 1};
    ...
    @Test
    public void delete() {
        byte[] apdu1 = {(byte)0x00, 0x03, 0x00, 0x00, 21, 6, '1', '2', '3', '4', '5', '6', 0, 6, 'S', 'E', 'C', 'R', 'E', 'T', 4, 'N', 'A', 'M', 'E', 1};
        byte[] resp = sim.transmitCommand(apdu1);
        assertArrayEquals(new byte[]{(byte)0x90, (byte)0x00}, resp);

        byte[] apdu2 = {(byte)0x00, 0x04, 0x00, 0x00, 8, 6, '1', '2', '3', '4', '5', '6', 0};
        resp = sim.transmitCommand(apdu2);
        assertArrayEquals(new byte[]{(byte)0x90, (byte)0x00}, resp);

        byte[] apdu3 = {(byte)0x00, 0x02, 0x00, 0x00, 8, 6, '1', '2', '3', '4', '5', '6', 0};
    ...
    public void status() {
        ...
        byte[] apdu2 = {(byte)0x00, 0x02, 0x00, 0x00, 8, 6, '1', '2', '3', '4', '5', '6', 0};
        resp = sim.transmitCommand(apdu2);
    ...
    public void hmacSHA1() {
        ...
        byte[] apdu2 = {(byte)0x00, 0x01, 0x00, 0x00, 18, 6, '1', '2', '3', '4', '5', '6', 0, 9, 'C', 'H', 'A', 'L', 'L', 'E', 'N', 'G', 'E'};
        resp = sim.transmitCommand(apdu2);
