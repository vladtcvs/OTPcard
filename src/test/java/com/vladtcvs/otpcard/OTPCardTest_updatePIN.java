...
public class OTPCardTest_updatePIN {
    ...
    public void Success() {
        // Send APDU
        byte[] apdu_good1 = {(byte)0x00, 0x05, 0x00, 0x00, 14, 6, '1', '2', '3', '4', '5', '6', 6, '6', '5', '4', '3', '2', '1'};
        byte[] apdu_good2 = {(byte)0x00, 0x05, 0x00, 0x00, 14, 6, '6', '5', '4', '3', '2', '1', 6, '6', '5', '4', '3', '2', '1'};
    ...
    public void Wrong_PIN() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x05, 0x00, 0x00, 15, 6, '1', '2', '3', '4', '5', '5', 7, '7', '6', '5', '4', '3', '2', '1'};
    ...
    public void Wrong_length_1() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x05, 0x00, 0x00, 15, 6, '1', '2', '3', '4', '5', '5', 8, '7', '6', '5', '4', '3', '2', '1'};
        byte[] resp = sim.transmitCommand(apdu);
    ...
    public void Wrong_length_2() {
        // Send APDU
        byte[] apdu = {(byte)0x00, 0x05, 0x00, 0x00, 15, 6, '1', '2', '3', '4', '5', '5', 6, '7', '6', '5', '4', '3', '2', '1'};
        byte[] resp = sim.transmitCommand(apdu);
        assertArrayEquals(new byte[]{(byte)0x67, (byte)0x00}, resp);
    }
